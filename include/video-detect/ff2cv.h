...
#ifndef VIDEO_DETECT_INCLUDE_VIDEO_DETECT_FF2CV_H_
 ...
 *                              limit the amount of frames to process by the receiver 
 * @param receiver              each non-limited frame is passed on to the receiver
 */
